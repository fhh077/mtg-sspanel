...
type SSPanelConfig struct {
	...
	HeartbeatInterval time.Duration `yaml:"heartbeat_interval" default:"1m"`
	TrafficBatchSize  int           `yaml:"traffic_batch_size" default:"50"`
	TrafficFlushDelay time.Duration `yaml:"traffic_flush_delay" default:"5s"`
}
